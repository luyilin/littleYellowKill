module.exports = {
    ...
    output: {
        path: __dirname + '/src/tpl', // 坑,输出目录需要和入口文件在同一目录下
        filename: '[name].js'
    },
    watch: true,
    module: {   // 加载器
    ...
    devServer: {
        ...
        /**
         * 坑,入口文件内引入bundle.js时需引入http://localhost:8080/bundle.js,这个才是webpack命令生成的js文件,若直接调用'bundle.js'
         * 则修改入口js文件不会自动刷新。ps修改html文件一直不会自动刷新
         */
